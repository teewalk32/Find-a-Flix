...
'height: 33rem; width: 20rem; background: #c71585d; dispaly: flex; align-items: center; justify-content: center');
userInfo.setAttribute('style',
'height: 33rem; background: #c71585d; dispaly: flex; flex-direction: column; align-items: center; justify-content: center');